...
export const works: work[] = [
  {
    ...
    image: "../assets/images/trap-collection-logo.png",
    tags: ["Go", "バックエンド"],
  ...
  },
  {
    ...
    serviceImage: "../assets/images/Questions-logo.png",
  ...
  },
  {
    ...
    image: "../assets/images/TheMysteryOfM.png",
    tags: ["Springin'", "ゲーム"],
    ...
    serviceImage: "../assets/images/TheMysteryOfM.png",
  },
  {
    title: "ポートフォリオサイト",
    description: "このサイトです。フロントエンドの練習として、Vue3+Typescriptで作りました。ここからブログ機能などを追加していきたいです。",
    image: "../assets/images/ikura-hamu_icon.png",
    tags: ["Vue.js", "フロントエンド"],
    service: "https://ikura-hamu.tech",
    serviceImage: "../assets/images/ikura-hamu_icon.png",
