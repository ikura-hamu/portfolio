...
export const works: work[] = [
  {
    ...
    image: "src/assets/images/trap-collection-logo.png",
    tags:["Go","バックエンド"],
  ...
  },
  {
    ...
    image:"src/assets/images/Questions.png",
    tags:["Go","バックエンド"],
    github:"https://github.com/ikura-hamu/questions",
    service:"https://questions-ui-silk.vercel.app",
    serviceImage:"src/assets/images/Questions-logo.png",
  ...
  },
  {
    ...
    image:"src/assets/images/TheMysteryOfM.png",
    tags:["Springin'", "ゲーム"],
    ...
    serviceImage:"src/assets/images/TheMysteryOfM.png",
  },
  {
    title:"ポートフォリオサイト",
    description:"このサイトです。フロントエンドの練習として、Vue3+Typescriptで作りました。ここからブログ機能などを追加していきたいです。",
    image:"src/assets/images/ikura-hamu_icon.PNG",
    tags:["Vue.js","フロントエンド"],
    service:"https://ikura-hamu.tech",
    serviceImage:"src/assets/images/ikura-hamu_icon.PNG",
